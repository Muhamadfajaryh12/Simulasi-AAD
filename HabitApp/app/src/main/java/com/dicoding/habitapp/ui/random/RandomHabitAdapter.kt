...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        fun bind(pageType: PageType, pageData: Habit) {
            ...
            when(pageType){
                PageType.LOW -> itemView.findViewById<ImageView>(R.id.pager_priority_level).setImageResource(R.drawable.ic_priority_low)
                PageType.MEDIUM -> itemView.findViewById<ImageView>(R.id.pager_priority_level).setImageResource(R.drawable.ic_priority_medium)
                PageType.HIGH -> itemView.findViewById<ImageView>(R.id.pager_priority_level).setImageResource(R.drawable.ic_priority_high)
            }
